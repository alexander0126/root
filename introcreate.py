...
class CreateCharacterWindow(ui.Window):
	...
	def Open(self):
		...
		try:
			...
			pythonScriptLoader.LoadScriptFile(dlgBoard, "sistimata/interface/characterwindow/create/createcharacterwindow.py")
		...
		if musicInfo.createMusic != "":
			...
			snd.FadeInMusic("miles/BGM/"+musicInfo.createMusic)

		app.ShowCursor()
		
	def Close(self):
		if musicInfo.createMusic != "":
			snd.FadeOutMusic("miles/BGM/"+musicInfo.createMusic)
