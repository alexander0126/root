...
if app.ENABLE_SYSTEM_METINSTONE:
	SAFEBOXX_QUESTINDEX = 0
	ANTIEXP_QUESTINDEX = 0
	TELEPORTE_QUESTINDEX = 0

if app.ENABLE_SYSTEM_APOSTOLES_SEON_VIOLOGO:
	BVIOLOGISTA_QUESTINDEX = 0
	SEONPYEONGA_QUESTINDEX = 0
	APOTHIKARIOS_QUESTINDEX = 0
	ENABLE_PICKUP = 0
	NYXTAMERASSS_QUESTINDEX = 0
...
CAMERA_MAX_DISTANCE_SHORT = 3500.0
