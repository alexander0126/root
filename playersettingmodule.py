...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+31, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-6.mse")##16 xrusi
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+32, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-5.mse")##17 kokkini
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+33, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-6.mse")##18 smaragdenia
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+34, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-1.mse")##19 asterakia petaei
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+35, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-2.mse")##20 kokkini fotia
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+36, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-3.mse")##21 prasini panoplia
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+37, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-3-4.mse")##22
	...
	net.RegisterEmoticonString("(Good)")
	...
	net.RegisterEmoticonString("(Depressed)")
	...
	net.RegisterEmoticonString("(Question)")
